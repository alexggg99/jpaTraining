...
insert into employee (id, name, salary) VALUE (2, 'Smirnov', 68000);
...
insert into employee (id, name, salary) VALUE (5, 'Pavlov', 120000);
...
insert into phone (id, number, type, employee_id) values (5, "787 8899", "WORK", 1);
insert into phone (id, number, type, employee_id) values (6, "676 8789", "HOME", 2);
